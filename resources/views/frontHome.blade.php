...
<body>
    ...
    <div class="header-area" id="headerArea">
        <div class="container">
            ...
            <div
                ...
                <!-- Logo Wrapper -->
                <div class="logo-wrapper"><a href="/login"><img src="{{ asset('assets/img/core-img/logo.png') }}"
                            alt=""></a></div>
                <!-- Navbar Toggler -->
    ...
    <div class="footer-nav-area" id="footerNav">
        <div class="container px-0">
            <h5 class="text-center">TUGAS UAS FRAMEWORK PROGRAMING - LARAVEL</h5>
            <p class="text-center">Adi Setyawan | David Galih | Farid</p>
            <!-- =================================== -->
