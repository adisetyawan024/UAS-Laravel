...
<div class="container">
    <div class="card">
      <div class="card-body p-2">
        <div class="d-flex align-items-center justify-content-between"><small class="ms-1">Tambah Pelanggan</small>
    ...
    <div class="card-body">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php if($d->status == '1'){ echo '<span class="m-1 badge bg-success">Aktif</span>'; }else if($d->status == '0'){echo '<span class="m-1 badge bg-danger">Nonaktif</span>';} ?></td>
                <td>
                    <?php $idEncryp = base64_encode('RouteAir'.$d->id); ?>
                    <a class="btn m-1 btn-creative btn-warning btn-sm" href="/admin/data-pelanggan/pembayaran/{{$idEncryp}}"><i class="bi bi-file-earmark-ruled"></i></a>
                    <a class="btn m-1 btn-creative btn-primary btn-sm" href="/admin/data-pelanggan/detail/{{$idEncryp}}"><i class="bi bi-pencil"></i></a>
                </td>
            </tr>
            @endforeach
        </tbody>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input class="form-control" id="in_kodePelanggan" name="in_kodePelanggan" type="text" placeholder="Kode Pelanggan">
            </div>
            <div class="form-group">
